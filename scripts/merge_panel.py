...
# Les mouse-bites du CLAVIER sont desormais dans niphar.kicad_pcb lui-meme
# (scripts/mousebites.py) : ils arrivent donc par la fusion, il ne faut surtout
# pas les reposer ici — sinon 140 trous au lieu de 76.
n2 = n3 = 0
say(f"  souris : {n} trous ; clavier : herites du board")
